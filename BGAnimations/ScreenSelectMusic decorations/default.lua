...
t[#t+1] = Def.BitmapText {
		Font = "Common Normal",
		InitCommand=cmd(horizalign,left;x,SCREEN_CENTER_X-620;y,SCREEN_CENTER_Y+343;zoom,0.545;shadowlength,1;diffusealpha,1;),
...
OnCommand=cmd(decelerate,0.5;addx,400;diffusealpha,1;addz,-100;bob;effectmagnitude,0,4,0;effecttiming,4,0,4,0;);
