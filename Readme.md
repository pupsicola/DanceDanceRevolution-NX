...
This theme is still a work in progress. There are several file name errors in the current build that will not be present in the final release. I'd recommend using the theme in full screen using SM 5.0.12 for the time being to avoid these errors.
